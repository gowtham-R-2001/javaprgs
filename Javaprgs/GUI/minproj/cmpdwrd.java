...
class ques extends JFrame
{
	...
	private static int cnt = 0, clueflg = 0;
	...
	*/
	...
	public Font f = new Font( "Arial", Font.BOLD | Font.ITALIC , 10 ) ;
	...
	*/
	...
	private JLabel wrong_answer_label;
	...
	public ques()
	{
		...
		//this.getContentPane().setBackground(new java.awt.color() ) ;
		...
		tf1 = new JTextField( 10 ) ;	tf1.setFont( f ) ;
		...
		wrong_answer_label = new JLabel("");
		wrong_answer_label.setBounds(130,10,410,410);
		...
		add(wrong_answer_label);
		wrong_answer_label.setVisible(false);
		...
		{	
			...
			if( (evnt.getSource() == b1) && (sflg == 1) )
			{
						...
						else
						{
							...
							lb3.setVisible( true ) ;
							lb3.setIcon( wrong ) ;
							wrong_answer_label.setText(answer[arr[cnt]] + " " + str[arr[cnt]]);
							wrong_answer_label.setVisible(true);
						}
